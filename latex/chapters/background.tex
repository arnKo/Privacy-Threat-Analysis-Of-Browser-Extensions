...
\subsubsection{Firefox Add-ons}
	...
	A certain module called \textit{chrome} grants full access to browser-internal functionality. This include the access to the host system with the user's privileges.  
