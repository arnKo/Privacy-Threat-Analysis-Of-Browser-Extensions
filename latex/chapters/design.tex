...
\label{sec:execution}
	...
	% state that content script equals host permission, interchangable depending on how the script was fetched, if executed with eval in content script extension needs content script, if executed with chrome.tabs.executeScript extension needs hos permission,
